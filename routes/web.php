...
Route::group(['middleware' => ['auth', 'verified', 'isPaket']], function () {
    ...
    Route::get('/kandang_table', [KandangController::class, 'kandang_table'])
        ->name('kandang.table')
        ->middleware('checkCom');
    ...
    Route::get('/mesin_table', [MesinController::class, 'mesin_table'])
        ->name('mesin.table')
        ->middleware('checkCom');

    Route::resource('ekspedisi', EkspedisiController::class)->middleware('checkCom');
    Route::get('/ekspedisi_table', [EkspedisiController::class, 'ekspedisi_table'])
        ->name('ekspedisi.table')
        ->middleware('checkCom');

    Route::resource('doc_box_option', DocBoxOptionController::class)->middleware('checkCom');
    Route::get('/doc_box_option_table', [DocBoxOptionController::class, 'table'])
        ->name('doc.box.option.table')
        ->middleware('checkCom');

    Route::resource('patroli_kandang', PatroliKandangController::class)->middleware('checkCom');
    Route::get('/kandang_suhu_table', [PatroliKandangController::class, 'kandang_suhu_table'])
        ->name('kandang.suhu.table')
        ->middleware('checkCom');
    Route::get('/kandang_kipas_table', [PatroliKandangController::class, 'kandang_kipas_table'])
        ->name('kandang.kipas.table')
        ->middleware('checkCom');
    Route::get('/kandang_alarm_table', [PatroliKandangController::class, 'kandang_alarm_table'])
        ->name('kandang.alarm.table')
        ->middleware('checkCom');
    Route::get('/kandang_lampu_table', [PatroliKandangController::class, 'kandang_lampu_table'])
        ->name('kandang.lampu.table')
        ->middleware('checkCom');

    Route::get('/patroli_kandang_xls', [PatroliKandangController::class, 'exportXls'])
        ->name('patroli.kandang.export.xls')
        ->middleware('checkCom');
    Route::get('/patroli_kandang_pdf', [PatroliKandangController::class, 'exportPdf'])
        ->name('patroli.kandang.export.pdf')
        ->middleware('checkCom');

    Route::resource('doc_out', DocOutController::class)->middleware('checkCom');
    Route::get('/doc_out_table', [DocOutController::class, 'doc_out_table'])
        ->name('doc.out.table')
        ->middleware('checkCom');
    Route::get('/doc_export_xls', [DocOutController::class, 'export_xls'])
        ->name('doc.export.xls')
        ->middleware('checkCom');
    Route::get('/doc_export_pdf', [DocOutController::class, 'export_pdf'])
        ->name('doc.export.pdf')
        ->middleware('checkCom');
    ...
    Route::post('/tampilkan_laporan_kandang', [LaporanKandangController::class, 'tampilkan_laporan'])
        ->name('tampilkan.laporan.kandang')
        ->middleware('checkCom');
    Route::post('/laporan_kandang_export_xls', [LaporanKandangController::class, 'export_xls'])
        ->name('laporan.kandang.export.xls')
        ->middleware('checkCom');
    Route::get('/laporan_kandang_export_pdf', [LaporanKandangController::class, 'export_pdf'])
        ->name('laporan.kandang.export.pdf')
        ->middleware('checkCom');
    ...
    Route::post('/update_password', [ProfileController::class, 'update_password'])->name('user.password.update');
    ...
    Route::post('/paket_gratis', [PaketLanggananController::class, 'paket_gratis'])
        ->name('paket.gratis')
        ->withoutMiddleware('isPaket');
    Route::post('/create_payment', [DuitkuController::class, 'create_payment'])
        ->name('create.payment')
        ->withoutMiddleware('isPaket');
    Route::get('/duitku_return', [PaketLanggananController::class, 'index'])
        ->name('duitku.return')
        ->withoutMiddleware('isPaket');

    Route::resource('riwayat', RiwayatController::class)->withoutMiddleware('isPaket');
    Route::get('/riwayat_table', [RiwayatController::class, 'riwayat_table'])
        ->name('riwayat.table')
        ->withoutMiddleware('isPaket');
    ...
    Route::post('/check_jenis_perusahaan', [PerusahaanController::class, 'check'])
        ->name('check.jenis.perusahaan')
        ->withoutMiddleware('isPaket');
    Route::post('/update_jenis_perusahaan', [PerusahaanController::class, 'update_jenis'])
        ->name('update.jenis.perusahaan')
        ->withoutMiddleware('isPaket');
