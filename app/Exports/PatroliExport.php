...
class PatroliExport implements FromCollection, WithHeadings, ShouldAutoSize
{
    use CommonTrait;
    ...
    public function collection()
    {
        ...
        $query = Patroli::select([
            'id', 'tanggal','jam', 'location_id','satpam_id', 'latitude','longitude','note','comid','created_at'
        ])
