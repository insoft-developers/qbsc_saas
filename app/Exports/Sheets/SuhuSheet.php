    ...
    WithEvents
{
    ...
    public function drawings()
    {
        ...
        foreach ($this->rows as $row) {
            ...
            $drawing = new Drawing();
            $drawing->setName('Foto Suhu');
            $drawing->setDescription('Foto Monitoring Suhu');
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                /** 🔹 Tinggi baris menyesuaikan foto */
                $rowIndex = 2;
