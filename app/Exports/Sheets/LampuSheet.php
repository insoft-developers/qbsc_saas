    ...
    WithEvents
{
    ...
    public function drawings()
    {
        ...
        foreach ($this->rows as $row) {
            ...
            $drawing = new Drawing();
            $drawing->setName('Foto Lampu');
            $drawing->setDescription('Foto Monitoring Lampu');
