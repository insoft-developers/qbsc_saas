...
class LampuSheet implements FromCollection, WithHeadings, ShouldAutoSize, WithTitle
{
    use CommonTrait;
    ...
    {
        $query = KandangLampu::select([
            'id','tanggal','jam','kandang_id','satpam_id','is_lamp_on','latitude','longitude','note','comid','created_at'
        ])
    ...
    {
        return [
            'Tanggal','Jam','Kandang','Nama Satpam','Lampu','Latitude','Longitude','Catatan','Sync Date','Perusahaan'
        ];
    }
