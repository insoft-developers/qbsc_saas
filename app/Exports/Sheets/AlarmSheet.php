    ...
    WithEvents
{
    ...
    public function drawings()
    {
        ...
        foreach ($this->rows as $row) {
            ...
            $drawing = new Drawing();
            $drawing->setName('Foto Alarm');
            $drawing->setDescription('Foto Monitoring Alarm');
