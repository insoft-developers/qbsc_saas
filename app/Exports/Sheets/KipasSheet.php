...
class KipasSheet implements FromCollection, WithHeadings, ShouldAutoSize,WithTitle
{
    use CommonTrait;
    ...
    {
        $query = KandangKipas::select([
            'id','tanggal','jam','kandang_id','satpam_id','kipas','latitude','longitude','note','comid','created_at'
        ])
    ...
    {
        return [
            'Tanggal','Jam','Kandang','Nama Satpam','Kipas','Latitude','Longitude','Catatan','Sync Date','Perusahaan'
        ];
    }
