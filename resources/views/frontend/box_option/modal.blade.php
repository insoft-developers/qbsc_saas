                  ...
                  <div class="modal-body">
                      <div class="row">
                          <div class="col-12">
                              ...
                              <div class="mb-2">
                                  <label for="jenis_box" class="form-label">Jenis Box Doc</label>
                                  <input type="text" id="jenis_box" name="jenis_box" class="form-control" placeholder="cth: Box Plastik, Box Polos">
                              </div>
