...
<head>
    <meta charset="utf-8" />
    <title>Reseller Admin Panel | QBSC</title>
    ...
    <style>
        .leftside-menu {
            background: rgb(47 57 211 / 86%) !important; 
        }
    </style>
...
<body>
        ...
        <div class="navbar-custom">
            <div class="topbar container-fluid">
                <div class="d-flex align-items-center gap-1">
                    ...
                    <!-- Page Title -->
                    @php
                        $resid = Auth::guard('reseller')->user()->id;
                        $reseller = \App\Models\Reseller::find($resid);

                    @endphp
                    <h4 class="page-title d-none d-sm-block">AKUN RESELLER</h4>
                </div>
                    ...
                    <li class="dropdown">
                        <a class="nav-link dropdown-toggle arrow-none nav-user" data-bs-toggle="dropdown"
                            ...
                            <span class="account-user-avatar">
                                <img src="{{ $reseller->foto == null ? asset('images/default.png') : asset('storage/' . $reseller->foto) }}"
                                    alt="user-image" width="32" height="32" class="rounded-circle">
                            </span>
                            <span class="d-lg-block d-none">
                                <h5 class="my-0 fw-normal">{{ Auth::guard('reseller')->user()->name }}<i
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated profile-dropdown">
                            ...
                            <form method="POST" action="{{ route('reseller.logout') }}">
                                ...
                                <a onclick="event.preventDefault();
                                    ...
                                    href="{{ route('reseller.logout') }}" class="dropdown-item">
    ...
    @if ($view == 'dashboard')
        ...
        <script>
            function copy_link() {
                const input = document.getElementById('referal_url');
                input.select();
