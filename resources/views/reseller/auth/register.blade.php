...
<head>
    <meta charset="utf-8">
    <title>Daftar Akun Reseller | QBSC</title>
...
<body>
    <div class="auth-card">
        ...
        <h3>DAFTAR AKUN RESELLER </h3>
        <p class="text-muted">Lengkapi data berikut untuk mendaftar menjadi Reseller QBSC.</p>
        ...
        <div class="auth-footer mt-3">
            Sudah punya akun Reseller? <a href="{{ route('reseller.login') }}">Login di sini</a>
        </div>
        {{-- <div class="divider">
            <span>Atau</span>
        </div>
