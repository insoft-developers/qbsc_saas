...
<head>
    <meta charset="utf-8">
    <title>Login Akun Reseller | QBSC</title>
...
<body>
    ...
    {{-- <img src="{{ asset('images/new_icon.webp') }}" alt="Logo QBSC"> --}}
        ...
        @error('error')
            ...
            <form style="margin-top: 20px;" method="POST" action="{{ route('reseller.login.post') }}">
                @csrf
            ...
            <div class="auth-footer mt-3">
                Belum punya akun reseller? <a href="{{ url('reseller/register') }}">Daftar di sini</a>
            </div>
            {{-- <div class="divider">
                <span>Atau</span>
            </div> --}}
